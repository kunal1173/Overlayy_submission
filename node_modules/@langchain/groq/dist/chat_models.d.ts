...
export declare class ChatGroq extends BaseChatModel<ChatGroqCallOptions, AIMessageChunk> {
    ...
    bindTools(tools: (Record<string, unknown> | StructuredToolInterface | ToolDefinition)[], kwargs?: Partial<ChatGroqCallOptions>): Runnable<BaseLanguageModelInput, AIMessageChunk, ChatGroqCallOptions>;
